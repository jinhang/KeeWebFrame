	...
	this._buildSurface = function() {
		...
		for (var r=0; r<this.tpl.childNodes[0].childNodes.length; r++) {
			...
			for (var c=0; c<tr.childNodes.length; c++) {
				...
				$(".dhtmlxLayoutPolySplitterVer div")[0].className = "clickbefore";				
				if (td._dir == "ver") {
					td.onselectstart = function(e) { e = e||event; e.returnValue = false; }
					td[this._isIPad?"ontouchstart":"onmousedown"] = function(e) {
						if(kcbmain.layout.items[0].getWidth()!=1){
							kcbmain.layout.items[0].setWidth(1);
							$("div.dhx_tabbar_row")[0].className = "dhx_tabbar_row1";
							//$(".dhtmlxLayoutPolySplitterVer")[0].style.background='url("imgs/theme/admin_baropen.gif") no-repeat';
							$(".dhtmlxLayoutPolySplitterVer div")[0].className = "clickafter";
						}else{
							$(".dhtmlxLayoutPolySplitterVer div")[0].className = "clickbefore";
							$("div.dhx_tabbar_row1")[0].className = "dhx_tabbar_row";
