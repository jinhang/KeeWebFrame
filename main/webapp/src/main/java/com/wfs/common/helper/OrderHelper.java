...
import static com.wfs.model.tables.Order.ORDER;
...
import com.kcb.common.sms.SendSms;
...
import com.wfs.common.jooq.CodeEnum.RedisLockType;
...
import com.wfs.redis.RedisLock;
...
public class OrderHelper {
	...
	public static Msg<List<Order>> getOrderList(Context context,String[] state,String begintime,
		...
		if(!(begintime==null || begintime.equals(""))){
			helper = helper.and(Expression.NotNull(begintime,ORDER.CREATETIME.ge(new Timestamp(DateUtil.getDateByFormatString(begintime,com.kcb.common.date.DateUtil.formart9).getTime()))));
		}
		if(!(endtime==null || endtime.equals(""))){
			helper = helper.and(Expression.NotNull(endtime,ORDER.CREATETIME.le(new Timestamp(DateUtil.getDateByFormatString(endtime,com.kcb.common.date.DateUtil.formart9).getTime()))));
		}
