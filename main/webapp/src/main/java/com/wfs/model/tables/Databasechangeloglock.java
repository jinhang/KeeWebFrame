...
public class Databasechangeloglock extends TableImpl<DatabasechangeloglockRecord> {
	...
	private static final long serialVersionUID = 923177192;

	/**
	 * The reference instance of <code>ewp.databasechangeloglock</code>
	 */
	...
	/**
	 * The column <code>ewp.databasechangeloglock.ID</code>.
	 */
	...
	/**
	 * The column <code>ewp.databasechangeloglock.LOCKED</code>.
	 */
	public final TableField<DatabasechangeloglockRecord, Byte> LOCKED = createField("LOCKED", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

	/**
	 * The column <code>ewp.databasechangeloglock.LOCKGRANTED</code>.
	 */
	...
	/**
	 * The column <code>ewp.databasechangeloglock.LOCKEDBY</code>.
	 */
	...
	/**
	 * Create a <code>ewp.databasechangeloglock</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>ewp.databasechangeloglock</code> table reference
	 */
