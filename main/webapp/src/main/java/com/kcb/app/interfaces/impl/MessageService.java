...
import com.kcb.app.interfaces.service.IMessageService;
...
import com.wfs.common.helper.NoteHelper;
...
public class MessageService implements IMessageService{
	...
	public Msg<String> saveMessage(String staffid, String telphone, String num,
		...
		Date mtime = DateUtil.getDateByFormatString(time,com.kcb.common.date.DateUtil.formart9);
