 ...
 * @version 创建时间：2012-8-6 上午9:34:00
 * 类说明
 */
public class ImageUtil {
	    ...
	    public static File rotateImage(File file,int degree) throws Exception{
	        if(degree==90) return rotateImageRight90(file);
	        if(degree==180) return rotateImageOppo(file);
	        if(degree==270) return rotateImageLeft90(file);
	        return null;
	    }

	    //左转90度
	    public static File rotateImageLeft90(File file) throws Exception{
	    ...
	    //右转90度
	    public static File rotateImageRight90(File file) throws Exception{
	        BufferedImage bufferedimage = ImageIO.read(file);
	        int w = bufferedimage.getWidth();
	        int h = bufferedimage.getHeight();
	        int type = bufferedimage.getColorModel().getTransparency();
	    ...
	    //对转
	    public static File rotateImageOppo(File file) throws Exception{
	        BufferedImage bufferedimage = ImageIO.read(file);
	        int w = bufferedimage.getWidth();
	        int h = bufferedimage.getHeight();
	        int type = bufferedimage.getColorModel().getTransparency();
