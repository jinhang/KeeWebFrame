...
public class EvationInfo {
	...
	private String etime;//时效
	
	private String percentage;//时效百分比
	
	private String countone;//时效1分单数
	
	private String counttwo;//时效2分单数
	
	private String countthree;//时效3分单数
	
	private String countfour;//时效4分单数
	
	private String countfive;//时效5分单数
	
	private String eattitude;//态度分
	
	private String apercentage;//态度百分比
	
	private String acountone;//态度1分单数
	
	private String acounttwo;//态度2分单数
	
	private String acountthree;//态度3分单数
	
	private String acountfour;//态度4分单数
	
	private String acountfive;//态度5分单数
