...
import com.kee.model.tables.pojos.Evaluation;
...
import cn.kee.common.jooq.CodeEnum.EvaType;
	...
	public List<OrderResult1> getOrderList(String userid, String begintime,
		...
		if(msg.getResult()){
			...
			for(int i=0;i<os.size();i++){
				...
				or1.setTime(com.kee.common.date.DateUtil.getCurrDateStr(com.kee.common.date.DateUtil.formart9,os.get(i).getCreatetime()));
				or1.setOrderid(os.get(i).getOrderid());
				if(os.get(i).getAsbegin()!=null && os.get(i).getApend()!=null){
					or1.setAsbegin(com.kee.common.date.DateUtil.getCurrDateStr(com.kee.common.date.DateUtil.formart9,os.get(i).getAsbegin()));
					or1.setApend(com.kee.common.date.DateUtil.getCurrDateStr(com.kee.common.date.DateUtil.formart9,os.get(i).getApend()));
				}
...
//			}		
	...
	public List<IMOResult> getImoMes(String orderid,Integer first,Integer limit,String evatype) {
		...
		if(rmsg.getResult()){
			...
			for(int i=0;i<imosm.size();i++){
				...
				imo.setCreatetime(com.kee.common.date.DateUtil.getCurrDateStr(com.kee.common.date.DateUtil.formart9,imosm.get(i).getCreatetime()));
	...
	public Msg<String> uploadRecords(String orderid, String records) {		
		String filename=orderid+com.kee.common.date.DateUtil.getCurrDateStr(com.kee.common.date.DateUtil.formart8,new Date())+".mp3";
