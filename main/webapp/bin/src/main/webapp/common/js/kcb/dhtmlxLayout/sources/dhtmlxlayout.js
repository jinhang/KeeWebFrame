...
function dhtmlXLayoutObject(base, view, skin) {
	...
	*	@type: public
	*/
	this.progressOn = function(text) {
		this._progressControlGlobal(true,text);
	}
	/**
	...
	*/
	...
	this._progressControl = function(id, state) {
		...
		if (this.polyObj[id]._progressCover == null) {
			...
			var pl_t = document.createElement("DIV");
			pl_t.className = "downText";
			p1.appendChild(pl_t);
			pl_t.innerHTML = "加载中";
	...
	this._progressControlGlobal = function(state,text) {
		text = text||"加载中...";
